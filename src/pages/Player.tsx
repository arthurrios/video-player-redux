    ...
    <div className="h-screen bg-zinc-950 text-zinc-50 flex justify-center items-center">
      <div className="flex w-[1100px] flex-col gap-6">
        <div className="flex items-center justify-between">
          ...
          <button className='flex items-center gap-2 bg-violet-500 px-3 py-2 rounded text-sm font-medium text-white hover:bg-violet-600'>
          ...
          <div className='flex-1'>
            <div className='w-full bg-zinc-950 aspect-video'>
              <ReactPlayer 
                ...
                height='100%'
                controls
                url="https://www.youtube.com/watch?v=HPtq8YK8fDQ"  
              />
            </div>
          </div>
          ...
          <aside className='w-80 absolute top-0 bottom-0 right-0 border-l divide-y-2 divide-zinc-900 border-zinc-800 bg-zinc-900 overflow-y-auto scrollbar-thin scrollbar-track-zinc-950 scrollbar-thumb-zinc-800'>
            ...
            <div>
              ...
              <nav className='relative flex flex-col gap-4 p-6'>
                <button className='flex items-center gap-3 text-sm text-zinc-600'>
                  <Video className='w-4 h-4 text-zinc-500'/>
                  <span>Fundamentos do Redux</span>
                  <span className='ml-auto font-mono text-xs text-zinc-500'>9:13</span>
                </button>
